...
const inputClass =
  "w-full bg-base-750 border border-border/60 rounded-lg px-3 py-2 text-sm text-text-primary placeholder:text-text-muted/50 focus:outline-none focus:border-border/60 focus:shadow-[inset_0_0_0_1px_var(--color-accent)] transition-colors";

const selectClass =
  "w-full bg-base-750 border border-border/60 rounded-lg px-3 py-2 text-sm text-text-primary focus:outline-none focus:border-border/60 focus:shadow-[inset_0_0_0_1px_var(--color-accent)] transition-colors appearance-none";
